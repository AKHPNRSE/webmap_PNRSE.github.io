...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:2154',
            extent: [-357823.236500, 6037008.693900, 1313632.362800, 7230727.377200],
            units: 'm'})
    })
});
...
map.getView().fit([711407.891754, 7024812.712091, 732407.891754, 7047347.327475], map.getSize());
